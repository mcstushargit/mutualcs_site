...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/uae`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/resources/how-to-choose-executive-search-firm`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/resources/cost-to-hire-cxo`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/candidates`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.3 },
